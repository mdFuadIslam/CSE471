...
$query="SELECT s.sId,s.serviceName,b.location,s.price,s.discount,b.catagory FROM `servicelist` as s INNER JOIN businesslist as b WHERE s.bId=b.bId and s.sId='$sId'";
...
<body>
    ...
    <?php
        ...
        echo "Service Code: '$data[0]'<br>
            Service Name: '$data[1]'<br>
            Location: '$data[2]'<br>
            Price: '$data[3]'<br>
            Discount: '$data[4]'<br>
            Catagory: '$data[5]'<br>";
        echo"<form method='post' action='bookService.php'>
            <input type='hidden' name='sId' id='sId' value='$sId'>
            <input type='submit' class='submit' value='Add to cart'></form><br>";
    ?>
    </div>
    </div>
</body>
