...
if (!empty($maxBudget)){
    ...
    $query.=" maxBudget<='$maxBudget'";
}
//$query="select * from grouplist where gCode='$gCode', loi='$loi', nom='$nom', etd='$etd', minBudget>='$minBudget',maxBudget<='$maxBudget'";
