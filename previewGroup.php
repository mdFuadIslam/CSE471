...
$query="select * from grouplist where gCode='$gCode'";
...
<body>
    ...
    <?php
        ...
        echo "Group Code: '$data[0]'<br>
            Group Name: '$data[1]'<br>
            Location of Interest: '$data[2]'<br>
            Budget Range: '$data[3]'-'$data[4]'<br>
            No. of members: '$data[5]'<br>
            Estimated duration of Trip: '$data[6]'<br>";
        $query="select username from groupinfo where gCode='$gCode'";
        $result = mysqli_query($con, $query);
        $len=mysqli_num_rows($result);
        echo "Joined members :'$len'<br>";
        if ($len>0){
        ...
        echo"<form method='post' action='joinGroup.php'>
            ...
            <input type='submit' class='submit' value='Join'></form><br>";
    ?>
    </div>
</body>
</html>