...
<body>
    ...
    <table>
        ...
        while ($data=mysqli_fetch_array($result)){
            ...
            $total+=$price;
            echo "<th>'$price'</th>";
            echo"<th><form method='post' action='removeItem.php'>
                <input type='hidden' name='sId' id='sId' value='$data[1]'>
    ...
    <input type='hidden' name='sum' id='sum' value='$total'>
    <input type='submit' class='submit' value='Proceed to pay'></form>";
    ?>
    </div>
    </div>
</body>
