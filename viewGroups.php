...
<body>
            ...
            <div class="site-header__start">
              <nav class="nav">
                ...
                <ul class="nav__wrapper">
                  <li class="nav__item"><a href="customerInterface.html">Home</a></li>
                  <li class="nav__item"><a href="viewGroups.php">Find Group</a></li>
                  <li class="nav__item"><a href="myGroup.php">My group</a></li>
                  <li class="nav__item"><a href="viewService.php">Book Service</a></li>
    ...
    <form method='post' action='sortGroup.php'>
        <input type='text' name='gCode' id='gCode' placeholder='gCode'>
        <input type='text' name='loi' id='loi' placeholder='loi'>
        <input type='text' name='minBudget' id='minBudget' placeholder='min Budget'>
        <input type='text' name='maxBudget' id='maxBudget' placeholder='max budget'>
        <input type="text" name="nom" id="nom" placeholder="no. of members">
        <input type="text" name="etd" id="etd" placeholder="Duration">
    ...
    <table>
        <tr>
            ...
            <th>budget range</th>
            <th>Member number</th>
            <th>Estimated Trip Duration (in days)</th>
            <th>Action</th>
        </tr>
        <?php
        $n=0;
        while ($data=mysqli_fetch_array($result)){
            ...
            echo "<th>'$data[0]'</th>
                ...
                <th>'$data[5]'</th>
                <th>'$data[6]'</th>
                <th><form method='post' action='previewGroup.php'>
                <input type='hidden' name='gCode' id='gCode' value='$data[0]'>
                <input type='submit' value='View'></form></th>";
            echo"</tr>";}
            $n=$n+1;
        }
        ?>
    ...
    <div class='center'>
        <div class="container">
            ...
            <input type='submit' name='submit' id='submit' class='submit' value='Create Group'></form>
        </div>
    </div>
</body>
</html>