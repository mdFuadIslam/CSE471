...
$query="select businessName,bId from businesslist where username='$username'";
...
<head>
    ...
    <title>View Active Profiles</title>
...
<table>
  ...
  <?php
    while ($data=mysqli_fetch_array($result)){
        ...
        <th><form method='post' action='manageBusiness.php'>
