...
$query="select businessName,bId from pendingapplication where username='$username'";
...
<head>
    ...
    <title>Profile Creation Applications</title>
    ...
    <?php
        ...
        <?php
            while ($data=mysqli_fetch_array($result)){
                ...
                <th><form method='post' action='viewApplication.php'>
                <input type='hidden' name='bId' id='bId' value='$data[1]'>
