...
<body>
    ...
    <div class="center">
        <div class="container">
    <form method='post' action="updatedService.php"><?php
        echo"Service Name:";
        echo "<input type='text' name='serviceName' id='serviceName' value='$data[2]'><br>";
        echo "Price:";
        echo "<input type='text' name='price' id='price' value='$data[3]'><br>";
        echo "Discount:";
        echo "<input tyep='text' name='discount' id='discount' value='$data[4]'><br>";
        echo "Negotiable:";
        echo "<input type='radio' name='negotiable' value='0'>0";
        echo "<input type='radio' name='negotiable' value='1'>1<br>";
