...
$query="select * from servicelist where sId='$sId'";
$result=mysqli_query($con,$query);
$data=mysqli_fetch_assoc($result);
$serviceName=$data['serviceName'];
$price=$data['price'];
$discount=$data['discount'];
$query="select * from usercart where username='$username' and sId='$sId'";
$result=mysqli_query($con,$query);
if (mysqli_num_rows($result)>0){
    ...
    //set quantity to 1
    $query="INSERT INTO usercart (username,sId,serviceName,price,discount,quantity) VALUES ('$username','$sId','$serviceName','$price','$discount',1)";
}
...
<body>
    ...
    <div class="container">
            ...
            <input type='submit' name='submit' id='submit' class='submit' value='Continue'></form>
    </div>
    </div>
    <div class='center'>
    <div class="container">
            <form action='cart.php'>
            <input type='submit' name='submit' id='submit' class='submit' value='Open Cart'></form>
    </div>
    </div>
</body>
</html>