...
$query="SELECT s.sId,s.serviceName,b.location,s.price,s.discount,b.catagory FROM `servicelist` as s INNER JOIN businesslist as b on s.bId=b.bId";
...
<body>
    ...
    <div class="center">
    <div class="container">
    <form method='post' action='sortService.php'>
        <input type='text' name='sId' id='sId' placeholder='Enter Service code'>
        <!--<input type='text' name='location' id='location' placeholder='Enter location'>-->
        <input type='text' name='minBudget' id='minBudget' placeholder='Enter min budget'>-
        <input type='text' name='maxBudget' id='maxBudget' placeholder='Enter max budget'>
    ...
    <table>
        ...
        while ($data=mysqli_fetch_array($result)){
            ...
            echo "<th>'$data[0]'</th>
                ...
                <th>'$data[4]'</th>
                <th>'$data[5]'</th>
                <th><form method='post' action='previewService.php'>
                <input type='hidden' name='sId' id='sId' value='$data[0]'>
                <input type='submit' value='View'></form></th>
                <th><form method='post' action='bookService.php'>
                <input type='hidden' name='sId' id='sId' value='$data[0]'>
