...
<body>
    ...
    <?php
    echo "$username,<br>";
    echo "send $total taka to 01533048777.<br>";
    ?>
    Payment Details:<br>
    <form method='post' action='invoice.php'>
        <input type='text'name='number' id='number' placeholder="Enter bKash Number">
        <input type='text'name='trx' id='trx' placeholder="Enter transacton Number">
        <input type='submit' name='submit' class='submit' placeholder="Confirm">
    </form>
    </div>
    </div>
</body>
